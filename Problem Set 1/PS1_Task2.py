...
df8 = df[['DEUTSCHE_BANK', "SAP", "ALLIANZ", "SIEMENS", "BMW", "RWE", "BAYER",
          "BASF"]]
df9 = df[['DEUTSCHE_BANK', "SAP", "ALLIANZ", "SIEMENS", "BMW", "RWE", "BAYER",
          "BASF", "E_ON"]]
df10 = df[['DEUTSCHE_BANK', "SAP", "ALLIANZ", "SIEMENS", "BMW", "RWE", "BAYER",
          "BASF", "E_ON", "HENKEL"]]
...
rdf8 = returns[['DEUTSCHE_BANK', "SAP", "ALLIANZ", "SIEMENS", "BMW", "RWE", "BAYER",
          "BASF"]]
rdf9 = returns[['DEUTSCHE_BANK', "SAP", "ALLIANZ", "SIEMENS", "BMW", "RWE", "BAYER",
          "BASF", "E_ON"]]
rdf10 = returns[['DEUTSCHE_BANK', "SAP", "ALLIANZ", "SIEMENS", "BMW", "RWE", "BAYER",
          "BASF", "E_ON", "HENKEL"]]
...
w5 = {'DEUTSCHE BANK': 1/5, 'SAP': 1/5, 'ALLIANZ': 1/5, 'SIEMENS': 1/5,
      'BMW': 1/5}
w6 = {'DEUTSCHE BANK': 1/6, 'SAP': 1/6, 'ALLIANZ': 1/6, 'SIEMENS': 1/6,
      'BMW': 1/6, 'RWE': 1/6}
w7 = {'DEUTSCHE BANK': 1/7, 'SAP': 1/7, 'ALLIANZ': 1/7, 'SIEMENS': 1/7,
      'BMW': 1/7, 'RWE': 1/7, 'BAYER': 1/7}
w8 = {'DEUTSCHE BANK': 1/8, 'SAP': 1/8, 'ALLIANZ': 1/8, 'SIEMENS': 1/8,
      'BMW': 1/8, 'RWE': 1/8, 'BAYER': 1/8, 'BASF': 1/8}
w9 = {'DEUTSCHE BANK': 1/9, 'SAP': 1/9, 'ALLIANZ': 1/9, 'SIEMENS': 1/9,
      'BMW': 1/9, 'RWE': 1/9, 'BAYER': 1/9, 'BASF': 1/9, 'E_ON': 1/9}
w10 = {'DEUTSCHE BANK': 1/10, 'SAP': 1/10, 'ALLIANZ': 1/10, 'SIEMENS': 1/10,
      'BMW': 1/10, 'RWE': 1/10, 'BAYER': 1/10, 'BASF': 1/10, 'E_ON': 1/10, 
      'HENKEL': 1/10}
...
y_axis_mean = [std1, std2_mean, std3_mean, std4_mean,
            std5_mean, std6_mean, std7_mean,
            std8_mean, std9_mean, std10_mean]
y_axis_rmean = [rstd1_mean, rstd2_mean, rstd3_mean,
                rstd4_mean, rstd5_mean, rstd6_mean,
                rstd7_mean, rstd8_mean, rstd9_mean, rstd10_mean]
y_axis_PF_std = [std1, PF2_Std, PF3_var,
                 PF4_Std, PF5_Std, PF6_Std,
                 PF7_Std, PF8_Std, PF9_Std,
                 PF10_Std]
